  ...
  nv.Scene = (function(_super) {
    ...
    function Scene(name, game, rootModel, options) {
      ...
      if (nv.gameConfig.scenes[this.sceneName].config.scene != null) {
        this.options = nv.extend(this.options, nv.gameConfig.scenes[this.sceneName].config.scene);
      }
  ...
  nv.Gamepad = (function(_super) {
    ...
    Gamepad.prototype.trackMouse = function() {
      ...
      nv.mousedown(function(event) {
        ...
        x = event.clientX;
        y = event.clientY;
        if ((event.touches != null) && event.touches[0]) {
          x = event.touches[0].clientX;
          y = event.touches[0].clientY;
        }
        _this.state.mouse.x = x;
        _this.state.mouse.y = y;
...
(function() {
  ...
  renderers.StrokeText = (function(_super) {
    ...
    StrokeText.prototype.draw = function(context, canvas) {
      var model, segment, segments, size, textWidth, x, y, _i, _len, _ref, _ref1;
      context.save();
      ...
      segments = nv.isArray(this.entity.model.text) ? this.entity.model.text : [this.entity.model.text];
      model = this.entity.model;
        ...
        entities: {
          ...
          hud: {
            ...
            model: {
              initializers: {
                ...
                ships: function() {
                  return [nv.extend({}, this.ship), (nv.extend({}, this.ship)).translate(20, 0), (nv.extend({}, this.ship)).translate(40, 0)];
                },
          ...
          left_button: {
            ...
            model: {
              initializers: {
                bounds: function() {
                  return new nv.Rect(0, 650, 100, 750);
                }
              },
              options: {
                action: "left"
          ...
          right_button: {
            ...
            model: {
              initializers: {
                bounds: function() {
                  return new nv.Rect(400, 650, 500, 750);
                }
              },
              options: {
                action: "right"
          ...
          shoot_button: {
            ...
            model: {
              initializers: {
                bounds: function() {
                  return new nv.Rect(0, 0, 500, 500);
                }
              },
              options: {
                action: "shoot"
